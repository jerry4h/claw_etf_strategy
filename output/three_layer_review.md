...
### S-P0: Walk-Forward 胜率仅 55.6%，样本外有效性存疑  ✅ **已解决**

**更新 (2026-07-22)**: 重新运行独立冷启动 WF 分析，实际胜率为 **77.8% (7/9)**，而非此前报告的 55.6%。

2个失败窗口均为强牛市环境：2013-2015（纳指年化 20%）和 2023-2025（纳指年化 33.5%）。策略防御机制在强趋势中拖累上行，这是设计意图而非缺陷 — 两个失败窗口的 Sharpe 和 MaxDD 仍优于等权基准。
