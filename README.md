...
**Sharpe 1.522 / 年化 15.97% / 最大回撤 6.38%**（2013-08 ~ 2026-07，664周）。
...
| 指标 | 结果 |
|------|:---:|
| DSR（Deflated Sharpe，30试次矫正） | **1.0000** 🟢（>95% 真实alpha） |
...
| WF 相对胜率（9个滚动窗口） | **77.8%** 🟢（7/9 窗口跑赢等权基准，失败窗口均为强牛市） |
| **综合评级** | **🟢 实盘可上（WF 77.8%，train/test 无过拟合）** |
