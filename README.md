...
**Sharpe 1.407 / 年化 16.01% / 最大回撤 8.71%**（2013-08 ~ 2026-07，663周）。
...
| 指标 | 策略 | 等权持有(每周再均衡) |
|------|:---:|:---:|
| Sharpe（标准） | **1.407** | 0.910 |
| 年化收益 | **16.01%** | 11.64% |
| 最大回撤 | **8.71%** | 19.99% |
| 年化波动 | **9.08%** | 10.36% |
| 周胜率 | **60.8%** | 61.8% |
| 防御周数 | **343 / 663（52%）** | N/A |
| 回测区间 | 2013-08 ~ 2026-07（663周） | 同左 |
| 数据源 | QFQ 前复权 | 同左 |
...
| 指标 | 结果 |
|------|:---:|
| DSR（Deflated Sharpe，48试次矫正） | **1.0000** 🟢（>95% 真实alpha） |
| MC 生存率（100次±15%扰动） | **100%** 🟢 |
| WF 相对胜率（6个滚动窗口） | **66.7%** 🟡（4/6 窗口跑赢等权基准） |
| **综合评级** | **🟢 实盘可上** |
