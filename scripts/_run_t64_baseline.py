#!/usr/bin/env python3
"""Phase 6 Full-Grid for v2.3 baseline"""
import sys, os
...
print("=" * 70)
print("Phase 6 Full-Parameter Grid — v2.3 Baseline")
...
# Convert full_grid for JSON serialization
grid_serializable = {}
if result.full_grid:
    for pname, glist in result.full_grid.items():
        ...
        for gp in glist:
            grid_serializable[pname].append({
                ...
                'sharpe': gp.sharpe if not (hasattr(gp, 'sharpe') and gp.sharpe != gp.sharpe) else None,  # NaN handling
