...
用法：
    ...
    python scripts/run_backtest.py --config config/strategy_v4_2.yaml
...
def main():
    ...
    parser.add_argument(
        '--config', type=str, default='config/strategy_v4_2.yaml',
        help='策略配置文件路径（默认: config/strategy_v4_2.yaml）'
    )
    parser.add_argument(
